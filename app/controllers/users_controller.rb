class UsersController < ApplicationController
  ...
  def authorize
    @graph = Koala::Facebook::GraphAPI.new('AAACEdEose0cBAD1vHd3AtzpygS7wCbHCSp2mYsmvhP6qIAGjPrUqM0rkIBu5z1jNpWGkfwssxllZClR6wSwN11qCBdrRosetL3BI4ggZDZD')
    @current_user = User.find_by_fb_id '804594794'
